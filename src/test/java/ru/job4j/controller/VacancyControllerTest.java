...
public class VacancyControllerTest {
    ...
    public void whenGetById() {
        ...
        var vacancy = new Vacancy(1, "test1", "desc1", now(), true, city1.getId(), 2);
    ...
    public void whenGetByUnknownIdThenResultError() {
        ...
        var model = new ConcurrentModel();
        var view = vacancyController.getById(model, 4);
        var actualExceptionMessage = model.getAttribute("message");
    ...
    @Test
    public void whenDeleteVacancy() throws IOException {
        var vacancy = new Vacancy(1, "test1", "desc1", now(), true, 1, 2);
